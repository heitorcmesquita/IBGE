...
trimestre = ['201201', '201202', '201203', '201204', '201301', '201302', '201303', '201304',
             ...
             '202001', '202002', '202003', '202004', '202101']
...
def getPNAD(indicador, trimestre):
    ...
    df['Tri'] = trimestre
    print(str(indicador) + ' ' + trimestre)
    return df

basePNAD = pd.DataFrame()
for i in bases:
    for j in trimestre:
        df = getPNAD(i, j)
        basePNAD = basePNAD.append(df)
        
basePNAD.to_csv('basePNAD.csv', encoding = 'UTF-8', index = False)
